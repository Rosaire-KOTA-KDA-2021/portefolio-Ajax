...
function getJsonDatas() {
  fetch(" https://my-json-server.typicode.com/rosaire-kota-kda-2021/portefolio-Ajax/developper")
...
class Developper {
  ...
  constructor(datas = []) {
    ...
    this.createDOMElements().forEach((htmlElement) => {
      this.renderBannerElements(htmlElement);
      this.renderAboutElements(htmlElement);
      this.renderSkillsElements(htmlElement);
      this.renderWorkElements(htmlElement);
    });
  }

  /**
   * Permet de rendre les elements HTML au niveau de la section bannierre
   */
  renderBannerElements(htmlElement) {
  ...
  /**
   * Permet de rendre les elements HTML au niveau de la section A PROPOS
   */
  renderAboutElements(htmlElement) {
   ...
   * Permet de rendre les elements HTML au niveau de la section A COMPETENCES
   */
  renderWorkElements(htmlElement) {
  ...
  /**
   * @returns {array} return un tableau d'objects{elemet HTML crees}
   */
  createDOMElements() {
